<template>
  <el-form class="searchForm">
    ...
    <el-form-item class="searchBtn">
      ...
      <el-button type="plain" @click="downloadUrl" style="margin-left: 20px"
        >下载模板</el-button
      >
    </el-form-item>
  </el-form>
...
import { communityInfoImport, equipmentTemplateDownload } from "@/api/community";
...
const downloadUrl = () => {
  equipmentTemplateDownload({}).then((item) => {
    ...
    link.download = "设备模版.xlsx"; // dowload属性指定文件名
    link.click();
  });
};

    ...
    <el-row :gutter="8">
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
        <el-card class="m-t8" shadow="never">
          <template #header>
            <div class="card-header">
              <!--              1 人口年龄分布  2  标签用户分布 3  流动人口增长趋势图	4 社区男女比例图  5 户籍人口占比图 6 党员人口占比图-->
      ...
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
        <el-card class="m-t8" shadow="never">
          <template #header>
            <div class="card-header">
              <span class="card-header-title">流动人口增长趋势图</span>
            </div>
          </template>
          <el-empty />
        </el-card>
      ...
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
        <el-card class="m-t8" shadow="never">
          <template #header>
            <div class="card-header">
              <span class="card-header-title">社区男女比例图</span>
            </div>
          </template>
          <el-empty />
        </el-card>
      ...
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
        <el-card class="m-t8" shadow="never">
          <template #header>
            <div class="card-header">
              <span class="card-header-title">户籍人口占比图</span>
            </div>
          </template>
          <el-empty />
        </el-card>
      ...
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
        <el-card class="m-t8" shadow="never">
          <template #header>
            <div class="card-header">
              <span class="card-header-title">党员人口占比图</span>
            </div>
          </template>
          <!--          <div class="text item">-->

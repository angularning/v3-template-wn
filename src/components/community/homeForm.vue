<template>
  <el-form class="searchForm">
    ...
    <el-form-item class="searchBtn">
      ...
      <el-button type="primary" @click="importChoose">导入Excel</el-button>
      <el-button type="plain" style="margin-left: 20px" @click="downloadUrl"
        >下载模板</el-button
      >
    </el-form-item>
  </el-form>
  <chooseImport ref="chooseImportType" :type="'home'" @reload="reload" />
</template>
...
const downloadUrl = () => {
  buildingRoomTemplateDownload({}).then((item) => {
    ...
    link.download = "房屋模版.xlsx"; // dowload属性指定文件名
    link.click();
  });
};
